package fi.abo.dt.st23.Assign1;/* DISCLAIMER: THIS CODE IS A MODIFIED VERSION OF THE ONE PROVIDED AT
    ...
    */
    ...
    public int[] calculateReturningCoins(double change) {
            ...
            if (change / Coin.OE.value >= 1) {
                    ...
                    change = change - (oneEuro * Coin.TE.value);
    ...
    /**
     * @param drink String drink selected
     * @param coin String coins selected
     * @return - String
